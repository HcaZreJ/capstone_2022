## Notes:
* Most of the work done since the "Mid-Term Deliverable assignment"
...
Word2Vec model, which captures the semantic difference between different words and different corpuses. 




Uses a Word2Vec model to turn News article content into vectors and learns the user's preference
by feeding them 10 news articles, summarizing based on learned user preference 
